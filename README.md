...
- **Planned / actual capacity** - Optional setting: every sprint item carries a planned and an actual capacity %. The prognosis matrix flips between the two with a toggle, and the Overview gains a **category trend** line chart (capacity % or completed-vs-planned % per category per sprint, category colours, click a legend entry to isolate a line)
