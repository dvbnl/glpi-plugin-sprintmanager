...
class SprintProblem extends CommonDBRelation
{
    ...
    public static function showForSprint(Sprint $sprint): void
    {
        ...
        if (count($links) === 0) {
            ...
            echo "<tr class='tab_bg_1'><td colspan='{$cols}' class='center'>" .
                __('No problems linked', 'sprint') . "</td></tr>";
        }
        ...
        foreach ($links as $row) {
            ...
            echo "<tr class='tab_bg_1'>";
            echo "<td>" . $problem->getID() . "</td>";
            echo "<td><a href='" . Problem::getFormURLWithID($problem->getID()) . "'>" .
                htmlescape($problem->fields['name']) . "</a></td>";
            echo "<td>" . Problem::getStatus($problem->fields['status']) . "</td>";
    ...
    public static function showForProblem(Problem $problem): void
    {
        ...
        if ($canedit) {
            echo "<div class='center'>";
            echo "<form method='post' action='" . static::getFormURL() . "'>";
            echo Html::hidden('problems_id', ['value' => $problemID]);
